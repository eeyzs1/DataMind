...
from datamind.core.factory import (
    get_storage, get_compute, get_export, get_ingestion,
    get_metadata, get_observability, get_query, load_profile,
)
...
async def natural_query(req: NaturalQueryRequest):
    ...
    if result:
        ...
        try:
            ...
            return {"question": req.question, "sql": result["sql"], "chart_type": result["chart"], "data": df.to_dict("records")}
        except Exception as e:
